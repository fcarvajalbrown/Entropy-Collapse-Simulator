...
ACM house rules honoured here:
  ...
  - Min 8 pages and an EVEN page count are submission requirements: check and
    ...
    python manuscript/build_docx_acm.py      # -> manuscript/out/Carvajal_ACM_manuscript.docx
"""
...
TEMPLATE = os.path.join(ROOT, "templates", "acmtempl.docx")
FIG = os.path.join(HERE, "figures")
OUTDIR = os.path.join(HERE, "out")
OUT = os.path.join(OUTDIR, "Carvajal_ACM_manuscript.docx")
